...
indexify:
	FAST_URL=fast.trychameleon.com HOST=trychameleon.com TARGET_FILE=index.js $(MAKE) build

devify:
	FAST_URL=localhost:3278 HOST=dev TARGET_FILE=index.dev.js $(MAKE) build
